          ...
          <header className="sticky top-0 z-30 border-b border-slate-200 bg-white px-4 py-3 lg:px-8">
            <div className="flex items-center gap-4">
              ...
              <div className="ml-auto flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={() => { setShowNotifications((v) => !v); setShowQuickAction(false); }}
                  className="relative hidden rounded-lg p-2 text-slate-500 transition hover:bg-slate-100 hover:text-brand-ink sm:block"
                >
